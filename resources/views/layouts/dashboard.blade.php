            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-pages">Inventory
                                Management</span>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPages" data-bs-toggle="collapse"
                                ...
                                <i class="ri-pages-line"></i> <span data-key="t-pages">Inventory Tracking</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('inventory-tracking.index') }}" class="nav-link"
                                            data-key="t-adjust-stock">
                                            Adjust Stock </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('inventory-tracking.stock-movements') }}" class="nav-link"
                                            data-key="t-stock-movements"> Stock Movements </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('inventory-tracking.availability-report') }}"
                                            class="nav-link" data-key="t-availability-reports"> Availability Reports
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse"
                                ...
                                <i class="ri-file-list-3-line"></i> <span data-key="t-forms">Stock Management</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarForms">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('stock.transfer.form') }}" class="nav-link"
                                            data-key="t-stock-transfer">Stock Transfer</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('stock.reconcile.form') }}" class="nav-link"
                                            data-key="t-reconcile-stock">
                                            Reconcile Stock </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('transfers.stock.movements') }}" class="nav-link"
                                            data-key="t-transfer-stock-movements">Transfer Stock Movements</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="menu-title"><i class="ri-more-fill"></i> <span
                                data-key="t-pages">Procurement</span>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('purchase-orders.index') }}">
                                <i class="ri-apps-2-line"></i> <span data-key="t-purchase-orders">Purchase
                                    Orders</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('purchase-transactions.index') }}">
                                <i class="ri-layout-3-line"></i> <span data-key="t-purchase-transactions">Purchase
                                    Transactions</span>
                            </a>
                        </li> <!-- end Dashboard Menu -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@yield('sub-title')</h4>
