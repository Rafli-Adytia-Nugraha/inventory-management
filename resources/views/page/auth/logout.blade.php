                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <img class="d-inline-block auth-logo" src="assets/images/logo-light.png" alt="" height="20">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted">Thank you for using <span class="fw-semibold">velzon</span></p>
                                    <div class="mt-4">
